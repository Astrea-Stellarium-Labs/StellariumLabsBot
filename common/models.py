...
class GuildConfig(Model):
    ...
    club_id: str | None = fields.CharField(50, null=True)
    playerlist_chan: int | None = fields.BigIntField(null=True)
    realm_id: str | None = fields.CharField(50, null=True)
    live_playerlist: bool = fields.BooleanField(default=False)  # type: ignore
    realm_offline_role: int | None = fields.BigIntField(null=True)
    ...
    live_online_channel: str | None = fields.CharField(75, null=True)  # type: ignore
...
class PremiumCode(Model):
    ...
    customer_id: str | None = fields.CharField(50, null=True)
